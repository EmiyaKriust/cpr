...
public class ScanSceneManager : MonoBehaviour
{
    ...
    public string deviceName = "HC-08";
    ...
    void Start()
    {
        try
        {
            ...
            Debug.Log($"Start: {bluetoothHelper}");
            ...
            text.text = "start ScanNearbyDevices";
            Debug.Log("start ScanNearbyDevices");
    ...
    void OnScanEnded(BluetoothHelper helper, LinkedList<BluetoothDevice> nearbyDevices)
    {
        ...
        {
            m_sb.Clear();
            m_sb.Append(nearbyDevices.Count).Append(" devices found:").AppendLine();
